...
#    d1 = np.random.randint(1,high=4,size=60)
...
for n in range(n_events):
    choice = np.random.randint(1,high=20)
    if choice <= 3:
        ...
        datum = np.random.randint(1,high=4,size=60)
...
#    weight = [1] * n_rolls
    weights = [[x * 3/19. for x in weight],[x * 9/19. for x in weight],[x * 6/19. for x in weight]]
#    print n
#    print weights
